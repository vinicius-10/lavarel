...
return [
    ...
    | usadas pela classe validadora. Algumas dessas regras têm múltiplas
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar nosso marcador
    | de posição de atributo com algo mais amigável ao leitor, como
    | "Endereço de E-Mail" em vez de "email". Isso simplesmente nos
    | ajuda a tornar nossa mensagem mais expressiva.
    |
    */
